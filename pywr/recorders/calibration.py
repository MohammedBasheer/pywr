...
"""
from .recorders import NumpyArrayNodeRecorder, NumpyArrayStorageRecorder
import numpy as np
...
class MeanAbsoluteErrorStorageRecorder(AbstractComparisonStorageRecorder):
    """ Recorder evaluates the MAE between model and observed """
    def values(self):
        mod = self.data
        obs = self._aligned_observed
...
class MeanSquareErrorStorageRecorder(AbstractComparisonStorageRecorder):
    """ Recorder evaluates the MSE between model and observed """
    def values(self):
        mod = self.data
        obs = self._aligned_observed
...
class RMSEStandardDeviationRatioStorageRecorder(AbstractComparisonStorageRecorder):
    """ Recorder evaluates the RMSE-observations standard deviation ratio between model and observed """
    def values(self):
        mod = self.data
        obs = self._aligned_observed
